...
const PatientProfileScreen = ({ navigation }) => {
  const handleLogout = () => {
    ...
    navigation.replace("PatientLoginScreen"); // Redirige a la pantalla de inicio de sesión
  };
  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.optionsContainer}>
        ...
        <TouchableOpacity style={styles.option} onPress={() => navigation.navigate("settingpatient")}>
