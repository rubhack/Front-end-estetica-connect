...
const ajustesprove= ({ navigation }) => {
  const handleLogout = () => {
    // Aquí puedes limpiar el estado o realizar cualquier otra acción necesaria
    navigation.replace("ProveedorLogScreen"); // Redirige a la pantalla de inicio de sesión
  };
  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.profileContainer}>
        ...
        />
        <Text style={styles.userName}>Wayne Industries</Text>
      </View>

      {/* Opciones */}
      <View style={styles.optionsContainer}>
        <TouchableOpacity style={styles.option} onPress={() => navigation.navigate("updateperfilprove")}>
